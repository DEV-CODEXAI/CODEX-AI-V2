    ...
    execute: async (sock, m, { reply }) => {
        ...
        try {
            ...
            if (isAnimated) {
                ...
                const cmd = `ffmpeg -y -framerate ${fps} -i "${frameDir}/frame_%04d.png" -vf "scale=512:-1:flags=lanczos,drawtext=text='CODEX AI':x=(w-text_w)/2:y=(h-text_h)/2:fontsize=30:fontcolor=white@0.6:borderw=2:bordercolor=black@0.7" -loop 0 -c:v libx264 -pix_fmt yuv420p -movflags +faststart -an "${output}"`
